...
static constexpr std::string_view hPtGeneratedRecoEv[nHistograms] = {"MC/el/pos_pdg/pt/generated_reco_ev", "MC/mu/pos_pdg/pt/generated_reco_ev", "MC/pi/pos_pdg/pt/generated_reco_ev",
                                                                     "MC/ka/pos_pdg/pt/generated_reco_ev", "MC/pr/pos_pdg/pt/generated_reco_ev", "MC/de/pos_pdg/pt/generated_reco_ev",
                                                                     "MC/tr/pos_pdg/pt/generated_reco_ev", "MC/he/pos_pdg/pt/generated_reco_ev", "MC/al/pos_pdg/pt/generated_reco_ev",
                                                                     "MC/el/neg_pdg/pt/generated_reco_ev", "MC/mu/neg_pdg/pt/generated_reco_ev", "MC/pi/neg_pdg/pt/generated_reco_ev",
                                                                     "MC/ka/neg_pdg/pt/generated_reco_ev", "MC/pr/neg_pdg/pt/generated_reco_ev", "MC/de/neg_pdg/pt/generated_reco_ev",
                                                                     "MC/tr/neg_pdg/pt/generated_reco_ev", "MC/he/neg_pdg/pt/generated_reco_ev", "MC/al/neg_pdg/pt/generated_reco_ev"};
...
static constexpr std::string_view hPtGeneratedPrmRecoEv[nHistograms] = {"MC/el/pos_pdg/pt/prm/generated_reco_ev", "MC/mu/pos_pdg/pt/prm/generated_reco_ev", "MC/pi/pos_pdg/pt/prm/generated_reco_ev",
                                                                        "MC/ka/pos_pdg/pt/prm/generated_reco_ev", "MC/pr/pos_pdg/pt/prm/generated_reco_ev", "MC/de/pos_pdg/pt/prm/generated_reco_ev",
                                                                        "MC/tr/pos_pdg/pt/prm/generated_reco_ev", "MC/he/pos_pdg/pt/prm/generated_reco_ev", "MC/al/pos_pdg/pt/prm/generated_reco_ev",
                                                                        "MC/el/neg_pdg/pt/prm/generated_reco_ev", "MC/mu/neg_pdg/pt/prm/generated_reco_ev", "MC/pi/neg_pdg/pt/prm/generated_reco_ev",
                                                                        "MC/ka/neg_pdg/pt/prm/generated_reco_ev", "MC/pr/neg_pdg/pt/prm/generated_reco_ev", "MC/de/neg_pdg/pt/prm/generated_reco_ev",
                                                                        "MC/tr/neg_pdg/pt/prm/generated_reco_ev", "MC/he/neg_pdg/pt/prm/generated_reco_ev", "MC/al/neg_pdg/pt/prm/generated_reco_ev"};
...
struct QaEfficiency {
  ...
  void makeMCHistograms(const bool doMakeHistograms)
  {
    ...
    registry->add(hPtIts[histogramIndex].data(), "ITS tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTpc[histogramIndex].data(), "TPC tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpc[histogramIndex].data(), "ITS-TPC tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTof[histogramIndex].data(), "ITS-TOF tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTpcTof[histogramIndex].data(), "TPC-TOF tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTrd[histogramIndex].data(), "ITS-TPC-TRD tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTof[histogramIndex].data(), "ITS-TPC-TOF tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTrdTof[histogramIndex].data(), "ITS-TPC-TRD-TOF tracks " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTrkItsTpc[histogramIndex].data(), "ITS-TPC track (reco) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGenerated[histogramIndex].data(), "Generated " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGeneratedRecoEv[histogramIndex].data(), "Generated Reco Ev. " + tagPt, kTH1D, {axisPt});

    registry->add(hPtItsPrm[histogramIndex].data(), "ITS tracks (primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTrkItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (reco primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTofPrm[histogramIndex].data(), "ITS-TPC-TOF tracks (primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTrkItsTpcTofPrm[histogramIndex].data(), "ITS-TPC-TOF tracks (reco primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGeneratedPrm[histogramIndex].data(), "Generated (primaries) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGeneratedPrmRecoEv[histogramIndex].data(), "Generated Reco Ev. " + tagPt, kTH1D, {axisPt});

    registry->add(hPtItsTpcStr[histogramIndex].data(), "ITS-TPC tracks (from weak decays) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtTrkItsTpcStr[histogramIndex].data(), "ITS-TPC tracks (reco from weak decays) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTofStr[histogramIndex].data(), "ITS-TPC-TOF tracks (from weak decays) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGeneratedStr[histogramIndex].data(), "Generated (from weak decays) " + tagPt, kTH1D, {axisPt});

    registry->add(hPtItsTpcMat[histogramIndex].data(), "ITS-TPC tracks (from material)" + tagPt, kTH1D, {axisPt});
    registry->add(hPtTrkItsTpcMat[histogramIndex].data(), "ITS-TPC tracks (reco from material) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtItsTpcTofMat[histogramIndex].data(), "ITS-TPC-TOF tracks ( from material) " + tagPt, kTH1D, {axisPt});
    registry->add(hPtGeneratedMat[histogramIndex].data(), "Generated ( from material) " + tagPt, kTH1D, {axisPt});

    registry->add(hPItsTpc[histogramIndex].data(), "ITS-TPC tracks " + tagPt, kTH1D, {axisP});
    registry->add(hPTrkItsTpc[histogramIndex].data(), "ITS-TPC tracks (reco) " + tagPt, kTH1D, {axisP});
    registry->add(hPItsTpcTof[histogramIndex].data(), "ITS-TPC-TOF tracks " + tagPt, kTH1D, {axisP});
    registry->add(hPGenerated[histogramIndex].data(), "Generated " + tagPt, kTH1D, {axisP});

    registry->add(hEtaItsTpc[histogramIndex].data(), "ITS-TPC tracks " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaTrkItsTpc[histogramIndex].data(), "ITS-TPC tracks (reco) " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaItsTpcTof[histogramIndex].data(), "ITS-TPC-TOF tracks " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaGenerated[histogramIndex].data(), "Generated " + tagEta, kTH1D, {axisEta});

    registry->add(hEtaItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (primaries) " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaTrkItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (reco primaries) " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaItsTpcTofPrm[histogramIndex].data(), "ITS-TPC-TOF tracks (primaries) " + tagEta, kTH1D, {axisEta});
    registry->add(hEtaGeneratedPrm[histogramIndex].data(), "Generated (primaries) " + tagEta, kTH1D, {axisEta});

    registry->add(hYItsTpc[histogramIndex].data(), "ITS-TPC tracks " + tagY, kTH1D, {axisY});
    registry->add(hYItsTpcTof[histogramIndex].data(), "ITS-TPC-TOF tracks " + tagY, kTH1D, {axisY});
    registry->add(hYGenerated[histogramIndex].data(), "Generated " + tagY, kTH1D, {axisY});

    registry->add(hPhiItsTpc[histogramIndex].data(), "ITS-TPC tracks " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiTrkItsTpc[histogramIndex].data(), "ITS-TPC tracks (reco) " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiItsTpcTof[histogramIndex].data(), "ITS-TPC-TOF tracks " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiGenerated[histogramIndex].data(), "Generated " + tagPhi, kTH1D, {axisPhi});

    registry->add(hPhiItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (primaries) " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiTrkItsTpcPrm[histogramIndex].data(), "ITS-TPC tracks (reco primaries) " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiItsTpcTofPrm[histogramIndex].data(), "ITS-TPC-TOF tracks (primaries) " + tagPhi, kTH1D, {axisPhi});
    registry->add(hPhiGeneratedPrm[histogramIndex].data(), "Generated (primaries) " + tagPhi, kTH1D, {axisPhi});
  ...
  void makeMCEfficiency(const bool doMakeHistograms)
  {
    ...
    makeEfficiency("ITS-TPC_vsPt_RecoEv", HIST(hPtItsTpc[histogramIndex]));
    ...
    makeEfficiency("ITS-TPC_vsPt_Prm_RecoEv", HIST(hPtItsTpcPrm[histogramIndex]));
  ...
  void fillMCEfficiency(const bool doMakeHistograms)
  {
    ...
    doFillEfficiency("ITS-TPC_vsPt_RecoEv", HIST(hPtItsTpcPrm[histogramIndex]), HIST(hPtGeneratedRecoEv[histogramIndex]));
    ...
    doFillEfficiency("ITS-TPC_vsPt_Prm_RecoEv", HIST(hPtItsTpcPrm[histogramIndex]), HIST(hPtGeneratedPrmRecoEv[histogramIndex]));
