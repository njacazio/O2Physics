...
// template <float etamin, float etamax, typename pdgDatabase>
// float countMultInAcceptance(const aod::McParticles& mcParticles, pdgDatabase pdgDB, const bool selectPrimaries = true)
// {
...
//     // primary
//     if (selectPrimaries && !particle.isPhysicalPrimary()) {
//       continue;
//     }
