...
static constexpr int kFV0MultZeqs = 8;
static constexpr int kFT0MultZeqs = 9;
static constexpr int kFDDMultZeqs = 10;
static constexpr int kPVMultZeqs = 11;
static constexpr int kMultsExtraMC = 12;
static constexpr int nTables = 13;
...
struct MultiplicityTable {
  ...
  Produces<aod::FV0MultZeqs> tableFV0Zeqs;    // 8
  Produces<aod::FT0MultZeqs> tableFT0Zeqs;    // 9
  Produces<aod::FDDMultZeqs> tableFDDZeqs;    // 10
  Produces<aod::PVMultZeqs> tablePVZeqs;      // 11
  Produces<aod::MultsExtraMC> tableExtraMc;   // 12
