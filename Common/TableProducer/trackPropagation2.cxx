...
struct TrackPropagation2 {
  ...
  PROCESS_SWITCH(TrackPropagation2, processStandard, "Process without covariance", true);
  ...
  PROCESS_SWITCH(TrackPropagation2, processCovariance, "Process with covariance", false);
};
...
{
  WorkflowSpec workflow{adaptAnalysisTask<TrackPropagation2>(cfgc)};
  return workflow;
}